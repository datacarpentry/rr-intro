...
ggplot(gap_north_america, aes(x = year, y = lifeExp, color=country)) + geom_line() + xlab("Year") + ylab("Life Expectancy (years)")
```
...
ggplot(gap_coi, aes(x = year, y = lifeExp, group=country, color=continent)) + geom_line() + xlab("Year") + ylab("Life Expectancy (years)")
...
ggplot(gap_europe, aes(x=gdpPercap, y = lifeExp)) + geom_point() + xlab("GDP (per capita)") + ylab("Life Expectancy (years)")
```

```{r}
gap_2007 <- subset(gap_combined, year == 2007)

ggplot(gap_2007, aes(x=gdpPercap, y = lifeExp, group=continent, color=continent)) + geom_point() + xlab("GDP (per capita)") + ylab("Life Expectancy (years)")
```
