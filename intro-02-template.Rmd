...
**Goal**: Create line plots of life expectancy over time for Canada, Mexico, and the 
United States that run from 1952 to 2007.
...
Given the example above, it's relatively simple to extend our analysis to include Asian and African countries. As before we subset our data frame on a list of countries.  One difference from the figure above is that this time we're coloring lines by the `contintent` variable rather than country name.  
