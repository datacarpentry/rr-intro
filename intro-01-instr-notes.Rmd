...
* Let's summarize what we've learned: 
    * We focused on 2 of the 4 problems, good documentation and sharing...

* Most people's preconcieved notions: **[TO DO: Pat to look over the following]**
    * "I don't have a problem with reproducibility."
    *  Organization session will adress the following:
        * "My projects aren't big enough for a folder structure."
        * "I am storing images. I am not doing computation."
        * "What is the difference in binary vs. text flies anyway?"
    * Publishing session will address the following:
    ...
    * Narration session will address the following:
        * "I will remember what I did / what may really non-descriptive column names and 
        codes mean two months from now."
        
        
    * "My projects aren't big enough for a folder structure.": Organization session will discuss this.
    * "I am not doing computation, I am just storing images."
